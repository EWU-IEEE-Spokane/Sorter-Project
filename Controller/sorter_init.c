...
void PortB_Init(void) {
    ...
    *GPIO_PORTB_IM    &= ~0x40;       // disable interrupts on pin 6
    *GPIO_PORTB_IS    &= ~0x40;       // make pin 6 edge triggered
    *GPIO_PORTB_IBE   &= ~0x40;       // don't trigger at both edges
    *GPIO_PORTB_IEV   |= 0x40;        // rising edge triggers
    *GPIO_PORTB_ICR   |= 0x40;        // clear RIS and MIS registers
    *GPIO_PORTB_IM    |= 0x40;        // enable interrupts on pin 6
}
